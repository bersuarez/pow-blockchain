...
class Blockchain:
            ...
            if not is_receiving:
                for node in self.__peer_nodes:
                    ...
                    try:
                        ...
                        continue #to keep on trying on the next nodes
            return True
        return False
    ...
    def mine_block(self):
        ...
        # }
        reward_transaction = Transaction('MINING', self.public_key,'', MINING_REWARD) #no necesitas firmas mining, lo verificas de otra forma
    ...
    def resolve(self):
        ...
        replace = False
        for node in self.__peer_nodes:
            url = 'http://{}/chain'.format(node) #get chain snapshot of anynode
            try:
